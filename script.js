    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סיסם עבודות עץ ייחודיות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0a9f97f7-2941-49a7-9a4b-f51214c82143',
                    name: data.name || '',
                    email: data.email || '',
